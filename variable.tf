...
variable initiative {
  ...
  default     = "terraform-azure-jlgonzalez"
}
...
variable vnet_name {
  ...
  default     = "terraform-scripting-azure-jlgonzalez"
}
...
variable subnet_1_vm_1 {
  description = "vm name"
  default     = "AZR-SANDBOX-jlgonzalez-01"
}

variable subnet_1_vm_2 {
  description = "vm name"
  default     = "AZR-SANDBOX-jlgonzalez-02"
}
